...
const v4_1 = __importDefault(require("node-html-constructor/versions/v4"));
 ...
 * @type {*}
 */
let builds = worker_threads_1.workerData?.builds || {};
...
function getTemplateSync(file, options) {
    ...
    return options ? (0, v4_1.default)(data, options) : data;
}
...
function getTemplate(file, options) {
    return new Promise((res, rej) => {
        ...
        fs.readFile(p, 'utf8', (err, data) => {
            ...
            data = runBuilds(data);
            templates.set(file, data);
            res(options ? (0, v4_1.default)(data, options) : data);
        });
    });
}
